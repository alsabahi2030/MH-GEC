...
from gector.datareader_early_v3 import Seq2LabelsDatasetReader
...
def get_data_reader(model_name, max_len, skip_correct=False, skip_complex=0,
                    ...
                    max_pieces_per_token=3, tn_prob=0, tp_prob=1, special_tokens_fix=0, multiclassifier=False, multiclassifier2=False, early_exit1=False, early_exit2=False):
    ...
    reader = Seq2LabelsDatasetReader(token_indexers=token_indexers,
                                     ...
                                     multiclassifier2 = multiclassifier2,
                                     early_exit1 = early_exit1,
                                     early_exit2 = early_exit2
...
def get_model(model_name, vocab, tune_bert=False,
    ...
    model = Seq2Labels(vocab=vocab,
                       ...
                       twolayers_classifier=twolaysers_classifier,
                       relu_activation=relu_activation,
                       multiclassifier=multiclassifier,
                       multiclassifier2=multiclassifier2,
                       early_exit1=early_exit1,
                       early_exit2=early_exit2,
                       multiheadversion=multiheadversion,
                       lamda=lamda
                       )
    return model
...
def main(args):
    ...
    namespaces = ['labels','ann_labels', 'd_tags','del_tags', 'rep_tags','app_tags','trans_tags','merge_tags']
    ...
    if torch.cuda.is_available():
        print(f"GPU {torch.cuda.device_count()} is available ")
    ...
    if args.pretrain:
        ...
        logging.info(f"Pretrained model {args.pretrain_folder}{args.pretrain}.th is loaded!")
    ...
    trainer = Trainer(model=model,
                      ...
                      annotation_dataset=annotation_data,
...
#                        default='roberta')
    ...
    parser.add_argument('--lamda',
                        type=float,
                        help='The scaling factor for multiclassifier.',
                        default=1.0)
